...
def node_classification():
    ...
    results_file = "results/all_results0.95.csv"
        ...
        for same_type_edge_reduction_ratio in same_type_edge_reduction_ratios:
            for feature_drop_ratio in feature_drop_ratios:
                for train_ratio in train_ratios:
                    ...
                    pd.DataFrame([experiment_result]).to_csv("results/all_results0.95.csv", mode='a', header=False, index=False)
                    print(experiment_result)
    print("Results saved to results/all_results0.95.csv")
